...
<main>
  ...
  <form class="form form--add-lot container form--invalid form--invalid" action="add.php" method="post" enctype="multipart/form-data"
> <!-- form--invalid -->
    <h2>Добавление лота</h2>
    <div class="form__container-two">
      <div class="form__item form__item--invalid"> <!-- form__item--invalid -->
        <?php $classname = isset($errors['title']) ? "form_input--error" : "";
      ...
      <?php $classname = isset($errors['category']) ? "form_input--error" : "";
        $value = isset($lot['category']) ? $lot['category'] : ""; ?>
        <label for="category" name"categories">Категория</label>
    ...
    <?php $classname = isset($errors['description']) ? "form_input--error" : "";
    ...
    <div class="form__item form__item--file"> <!-- form__item--uploaded -->
      ...
      <?php $classname = isset($errors['image']) ? "form_input--error" : "";
    ...
    <div class="form__container-three">
      ...
      <?php $classname = isset($errors['lot-rate']) ? "form_input--error" : "";
      ...
      <div class="form__item form__item--small">
      <?php $classname = isset($errors['step-lot']) ? "form_input--error" : "";
      $value = isset($lot['step-lot']) ? $lot['step-lot'] : ""; ?>
        <label for="lot-step">Шаг ставки</label>
        <input id="lot-step" type="number" name="step-lot" placeholder="0" required>
        <span class="form__error">Введите шаг ставки</span>
      </div>
      <div class="form__item">
      <?php $classname = isset($errors['end-date']) ? "form_input--error" : "";
      $value = isset($lot['end-date']) ? $lot['end-date'] : ""; ?>
        <label for="lot-date" name="end date">Дата окончания торгов</label>
        <input class="form__input-date" id="lot-date" type="date" name="end-date-lot" required>
    ...
    <?php endforeach; ?>
    <?php $classname = isset($errors['send']) ? "form_input--error" : "";
      $value = isset($lot['send']) ? $lot['send'] : ""; ?>
    <?php endif; ?>
