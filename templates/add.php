  ...
  <?php $classname = isset($errors['lot-name']) ? "form--invalid" : ""; 
        $value = isset($gif['lot-name']) ? $gif['lot-name'] : ""; ?>
  <form class="form form--add-lot container form--invalid" action="add.php" method="post"> <!-- form--invalid -->
    <h2>Добавление лота</h2>
    <div class="form__container-two">
      <div class="form__item form__item--invalid <?=isset($errors['lot-name'])?'form__item--invalid':'';?>"> <!-- form__item--invalid -->
